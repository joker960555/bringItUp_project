...
/*#__PURE__*/
function () {
  function Slider(pageSel, buttonSel) {
    _classCallCheck(this, Slider);

    this.page = document.querySelector(pageSel), this.slides = this.page.children, this.buttons = document.querySelectorAll(buttonSel), this.slideIndex = 1;
  }
