...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var sliderMainShowup = new _modules_slider_sliderMain__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    buttons: '.next'
  });
  sliderMainShowup.render();
  var sliderMiniShowup = new _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var sliderMiniModules = new _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var sliderMiniFeed = new _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      descr = _ref$descr === void 0 ? null : _ref$descr,
      _ref$decorate = _ref.decorate,
      decorate = _ref$decorate === void 0 ? false : _ref$decorate,
      _ref$autoplay = _ref.autoplay,
      autoplay = _ref$autoplay === void 0 ? false : _ref$autoplay;

  _classCallCheck(this, Slider);

  this.container = document.querySelector(container), this.slides = this.container.children, this.buttons = document.querySelectorAll(buttons), this.next = document.querySelector(next), this.prev = document.querySelector(prev), this.active = active, this.descr = descr, this.decorate = decorate, this.autoplay = autoplay, this.slideIndex = 1;
};
...
function (_Slider) {
  ...
  function SliderMain(container) {
    _classCallCheck(this, SliderMain);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMain).call(this, container));
  }
    ...
    value: function nextSlide(n) {
      ...
      this.buttons.forEach(function (item) {
        item.addEventListener('click', function (e) {
          ...
          _this.showSlides(_this.slideIndex += n);
    ...
    value: function showAdvBlock() {
      ...
      if (this.slideIndex === 3) {
        this.timeout = setTimeout(function () {
          _this2.adv.style.display = 'block';

          _this2.adv.classList.add('animated', 'fadeInUp');
        }, 3000);
      } else {
...
function (_Slider) {
  ...
  function SliderMini(container, slides, next, prev, decorate, autoplay) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, container, slides, next, prev, decorate, autoplay));
  }
    ...
    value: function prevSlide() {
      ...
      this.slides.forEach(function (sl) {
        if (sl.tagName === 'BUTTON') {
          _this3.container.insertBefore(sl, _this3.slides[_this3.slides.length - 3]);
        }
      });
...
/*#__PURE__*/
function () {
  function Player(triggerSel, overlaySel, closeSel) {
    _classCallCheck(this, Player);

    this.triggers = document.querySelectorAll(triggerSel), this.overlay = document.querySelector(overlaySel), this.close = this.overlay.querySelector(closeSel);
  }
  ...
  _createClass(Player, [{
    ...
    key: "createPlayer",
    value: function createPlayer(path) {
      ...
      this.triggers.forEach(function (item) {
        item.addEventListener('click', function () {
          if (document.querySelector('iframe#frame')) {
            ...
            var path = item.parentNode.getAttribute('data-url');
